const arrCruise = [
    ...
    },
    {
        name :"BAHAMAS",
        price :"1000",
        description :"Cruise through the Bahamas and discover a paradise of turquoise waters, pristine beaches, and vibrant culture, where relaxation and adventure await on every island. Explore this tropical wonderland and create unforgettable memories",
        image : "fernando-jorge-rMaWin9-9Gk-unsplash.jpg",
        date : "10 NIGHTS",
        depart : "DEPART FROM Port Canaveral, 9AM",
        destination : ["DESTINATION Bahamas, 7AM"],
        singleDestination : "Single Destination: yes",
        multiDestination: "Multi Destination: No",
        roundTrip :"Round Trip : No",
    },
    {
        name :"EUROPE",
        price :"420",
        description :"Embark on a European cruise to journey through centuries of history, savor diverse cuisines, and witness iconic landmarks along the enchanting rivers and coastal gems of this timeless continent. Experience the rich tapestry of Europe as you explore its captivating ports, each offering a unique chapter in this grand adventure.",
        image : "alexander-ramsey-dBtWLliLt5k-unsplash.jpg",
        date : "7 NIGHTS",
        depart : "DEPART FROM Marseille, 9AM",
        destination : ["DESTINATION Europe, 7AM"],
        singleDestination : "Single Destination: No",
        multiDestination: "Multi Destination: Yes",
        roundTrip :"Round Trip : Yes",
    },
    {
        name :"AFRICA",
        price :"350",
        description :"Cruise to the Portuguese Islands, where charming fishing villages, stunning cliffs, and vibrant culture beckon travelers to experience the essence of coastal Portugal. From the picturesque Azores to the sun-kissed shores of Madeira, these islands offer a captivating blend of natural beauty and maritime heritage.",
        image : "daniele-franchi-UU4yFsZN_FY-unsplash.jpg",
        date : "2 NIGHTS",
        depart : "DEPART FROM Durban, 9AM",
        destination : ["DESTINATION Portuguese Island, 7AM"],
        singleDestination : "Single Destination: Yes",
        multiDestination: "Multi Destination: No",
        roundTrip :"Round Trip : No",
    },
